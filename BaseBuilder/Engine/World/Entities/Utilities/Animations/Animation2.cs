...
namespace BaseBuilder.Engine.World.Entities.Utilities.Animations
{
    ...
    {
        public List<AnimationFrame2> Frames { get; protected set; }
        ...
        public Animation2(List<AnimationFrame2> frames, Direction? direction, int cycleStartFrame = 0, int beginFrame = 0)
        {
            Frames = frames;
            Direction = direction;
